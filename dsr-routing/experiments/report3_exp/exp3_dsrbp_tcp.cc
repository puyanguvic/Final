...
std::string expName = "exp3-dsrbp-tcp";
...
int main (int argc, char *argv[])
{
  ...
  sourceHelper.SetAttribute ("MaxBytes", UintegerValue (600));
  ...
  AnimationInterface anim("exp3-dsr-tcp.xml");
  ...
  ("exp3-dsr-tcp.routes", std::ios::out);
