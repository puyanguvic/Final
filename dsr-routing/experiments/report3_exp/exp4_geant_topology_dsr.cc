...
int main (int argc, char *argv[])
{
  ...
  // to install DSRVirtualQueue to every device by the traffic control layer in the layer 2

  // it create little subnets, one for each couple of nodes.
  ...
  app->Setup (udpSocket, sinkAddress, 1000, 50000, DataRate ("13Mbps"), 300,false);
